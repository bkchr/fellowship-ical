...
// get the value for an account
    const accountInfo = await Promise.all([fellowshipApi.query.FellowshipSalary.Claimant.getValue("13fvj4bNfrTo8oW6U8525soRp6vhjAFLum6XBdtqq9yP22E7"), fellowshipApi.query.FellowshipSalary.Status.getValue()]);
    const finalizedBlock = await client.getFinalizedBlock();

    const timestamp = await fellowshipApi.query.Timestamp.Now.getValue({at: finalizedBlock.hash});
